...
# Full test with the 15 conflicting rooms
rooms = [
    {"id": "1", "name": "Pool de Trabajo", "type": "Pool de Trabajo", "width": 10.0, "height": 6.0},
    ...
    {"id": "12", "name": "Comedor", "type": "Comedor", "width": 6.0, "height": 4.0},
    {"id": "13", "name": "SS.HH", "type": "SS.HH", "width": 4.0, "height": 4.0},
    {"id": "14", "name": "Kitchenette", "type": "Kitchenette", "width": 3.0, "height": 3.0},
    {"id": "15", "name": "Cabina Telefónica", "type": "Cabina Telefónica", "width": 1.5, "height": 1.5}
]
...
try:
    ...
    if response.status_code == 200:
        data = response.json()
        with open("C:/temp/full_test_15_v2.json", "w", encoding="utf-8") as f:
            json.dump(data, f, indent=2, ensure_ascii=False)
        print("Success! Checked C:/temp/full_test_15_v2.json")
    else:
